  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const userData = {
        ...
        pets: [
          { id: '1', name: 'Luna', type: 'Gato', image: 'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=400&h=400&fit=crop' }
        ]
      };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-white to-purple-100 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Bem-vindo de volta! Entre na sua conta</p>
        </div>
